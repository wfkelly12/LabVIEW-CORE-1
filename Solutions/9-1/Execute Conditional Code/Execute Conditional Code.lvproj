...
<Project Type="Project" LVVersion="19008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="[Challenge] Condition Based on Measurement Result with Running Total.vi" Type="VI" URL="../[Challenge] Condition Based on Measurement Result with Running Total.vi"/>
		<Item Name="Condition Based on Measurement Result.vi" Type="VI" URL="../Condition Based on Measurement Result.vi"/>
		<Item Name="Condition Based on User Input (Triggering).vi" Type="VI" URL="../Condition Based on User Input (Triggering).vi"/>
